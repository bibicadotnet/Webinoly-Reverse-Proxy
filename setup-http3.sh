...
sudo wget --no-check-certificate https://raw.githubusercontent.com/bibicadotnet/Webinoly-Reverse-Proxy/main/reverse-proxy-nginx-http3.conf -O /opt/webinoly/webinoly.conf
